...
ROOT=Path(r'D:\Computational Metagenomics\Manuscript_Package_Multiomics')
FIG_DIR=ROOT/'figures'; FIG_DIR.mkdir(parents=True,exist_ok=True)
TITLES=['Multiomics integration architecture', 'Illustrative cross-modal feature correlation matrix', 'Illustrative latent-space cohort separation', 'Decision framework for practical multiomics study design']
