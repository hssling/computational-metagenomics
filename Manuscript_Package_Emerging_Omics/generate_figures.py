...
ROOT=Path(r'D:\Computational Metagenomics\Manuscript_Package_Emerging_Omics')
FIG_DIR=ROOT/'figures'; FIG_DIR.mkdir(parents=True,exist_ok=True)
TITLES=['Landscape of emerging omics technologies', 'Illustrative technology maturity matrix', 'Illustrative translational readiness plot', 'Framework for choosing emerging omics assays']
