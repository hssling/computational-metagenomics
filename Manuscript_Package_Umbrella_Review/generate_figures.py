...
ROOT=Path(r'D:\Computational Metagenomics\Manuscript_Package_Umbrella_Review')
FIG_DIR=ROOT/'figures'; FIG_DIR.mkdir(parents=True,exist_ok=True)
TITLES=['Continuum from genomics to spatiotemporal omics', 'Comparative modality matrix', 'Integrated assay-selection decision map', 'Shared computational principles across omics domains']
