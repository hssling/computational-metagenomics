...
ROOT=Path(r'D:\Computational Metagenomics\Manuscript_Package_Spatiotemporal_Omics')
FIG_DIR=ROOT/'figures'; FIG_DIR.mkdir(parents=True,exist_ok=True)
TITLES=['Spatiotemporal omics analytical framework', 'Illustrative temporal trajectory landscape', 'Illustrative 4D tissue-state map', 'Alignment and inference logic for dynamic spatial studies']
