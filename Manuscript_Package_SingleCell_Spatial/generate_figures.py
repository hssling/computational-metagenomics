...
ROOT=Path(r'D:\Computational Metagenomics\Manuscript_Package_SingleCell_Spatial')
FIG_DIR=ROOT/'figures'; FIG_DIR.mkdir(parents=True,exist_ok=True)
TITLES=['Single-cell and spatial omics workflow', 'Illustrative cell-state manifold', 'Illustrative spatial tissue map', 'Integrated single-cell to spatial interpretation framework']
